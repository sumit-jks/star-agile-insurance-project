node{
    ...
    stage('git code checkout'){
        try{
            ...
            git 'https://github.com/sumit-jks/star-agile-insurance-project.git'
        }
        catch(Exception e){
            ...
            ${BUILD_URL}''', subject: 'Job ${JOB_NAME} ${BUILD_NUMBER} is failed', to: 'sumit.jks2k5@gmail.com'
        }
    }
    ...
    stage('Containerize the application'){
        ...
        sh "${dockerCMD} build -t s98singh/insure-me:${tagName} ."
    }
